...
- DatasetA_recode01.fasta - The alignment of 54 genomes and transcriptomes published in Soghigian et al. 2023, but recoded following a 01/RY strategy. Also has an associated nt.123.parts and nt.3.parts file, which are partition files.
